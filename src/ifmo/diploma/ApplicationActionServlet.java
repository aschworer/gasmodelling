package ifmo.diploma;

import ifmo.diploma.DAO.DAOFactory;
...
public class ApplicationActionServlet extends ActionServlet {
    ...
    private static Log logger = LogFactory.getLog(ApplicationActionServlet.class);
    public static final String UPLOADS_DIR = "diploma_uploads\\";
    public static final String WEBAPP_HOME_DIR = "..\\webapps\\";
    public static final String FULL_UPLOADS_DIR = WEBAPP_HOME_DIR + UPLOADS_DIR;

    public static final String CURRENT_USERNAME_ATTR = "currentUserName";
    public static final String CURRENT_USERGROUP_ATTR = "currentUserGroup";

    public static final String HOME_FORWARD = "Home";
...
//      logger.error("Cannot instanciate Action Servlet cause of database access error", e);
    ...
    public static void copyFileToServer(String userID, FormFile fileSrc) throws java.io.IOException {
        ...
        File dir = new File(ApplicationActionServlet.FULL_UPLOADS_DIR + userID + "\\");
        if (!dir.exists()) {
            dir.mkdirs();
        }
        File file = new File(ApplicationActionServlet.FULL_UPLOADS_DIR + userID + "\\" + fileName);
        if (!file.exists()) {
            file.createNewFile();
        }
